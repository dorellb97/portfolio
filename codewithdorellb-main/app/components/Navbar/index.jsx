    ...
    <div className={styles.back}>
      ...
      <div className={styles.center}>
        <Dropdown>
          ...
          >
            <Dropdown.Item href="/#projects" key="Css">
              CSS Project
            </Dropdown.Item>
            <Dropdown.Item href="/#projects" key="JS">
              JS Projects
            </Dropdown.Item>
            <Dropdown.Item href="/#projects" key="Games">
              Games
            </Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
        ...
        <Link
          href="https://cavalryconvincing.com/aezu35fz?key=53e580f61d2823c197e0f8f414fd3e51"
          style={{ textDecoration: "none" }}
        >
          <p>{t("ADS")}</p>
        </Link>
        <Link
          href="https://www.buymeacoffee.com/codewithdorellb"
          target="_blank"
          style={{ textDecoration: "none" }}
        >
        ...
        {auth && (
          <div>
            <Link href="/admin/createpost" style={{ textDecoration: "none" }}>
              <p>Create post</p>
            </Link>
      ...
      <div className={styles.last}>
        <a
          href="https://www.instagram.com/codewith_dorell.b/"
          style={{ textDecoration: "none" }}
        >
          <Image src="/instagram.svg" width={35} height={35} />
        </a>
        <a
          href="https://t.me/codewith_dorellb"
          style={{ textDecoration: "none" }}
        >
          <Image src="/tg.svg" width={35} height={35} />
        </a>
        <a
          href="https://www.youtube.com/@codewith_Dorell.B"
          style={{ textDecoration: "none" }}
        >
          <Image src="/youtube.svg" width={35} height={47} />
        </a>
      </div>
            ...
            <>
              <div className={styles.backmenu}>
                ...
                <div
                  className={
                    auth
                      ? `${styles.info_links_admin} ${styles.info_links}`
                      : styles.info_links
                  }
                >
                  <Dropdown>
                  ...
                  <Link prefetch={false} href="/disclaimer">
                    <div>{t("header:disclaimer")}</div>
                  </Link>
                  <Link prefetch={false} href="/privacy-policy">
                    <div>{t("header:privacy_policy")}</div>
                  </Link>
                  <Link
                    prefetch={false}
                    href="https://cavalryconvincing.com/aezu35fz?key=53e580f61d2823c197e0f8f414fd3e51"
                  ...
                  <div className={styles.box_contacts}>
                    <div className={styles.first_child}>
                      <a href="https://www.instagram.com/codewith_dorell.b/">
                        <div>
                          <Image
                            src="/instagram.svg"
                            alt="."
                      ...
                      <a href="https://t.me/codewith_dorellb">
                        <div>
                          <Image src="/tg.svg" alt="." width={40} height={40} />
                        </div>
                      </a>
                      <a href="https://www.youtube.com/@codewith_Dorell.B">
                        <div>
                          <Image
                            src="/youtube.svg"
                            alt="."
