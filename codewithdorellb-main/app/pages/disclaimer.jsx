    ...
    <div className={styles.preback}>
      ...
      <ul>
        <li>
          ...
          this Disclaimer) refers to CodewithDorellB.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to CodewithDorellB, accessible from{" "}
          <a
            href="https://codewithdorellb.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://codewithdorellb.com
          </a>
        </li>
      </ul>
      <h1>Disclaimer</h1>
      ...
      <ul>
        <li>By email: codewithdorell.b@gmail.com</li>
      </ul>
    </div>
    </div>
  );
